...
ActiveRecord::Schema.define(:version => 20140206174722) do
  ...
  add_index "hours", ["jobsite_id"], :name => "index_hours_on_jobsite_id"
  ...
  add_index "tools", ["jobsite_id"], :name => "index_tools_on_jobsite_id"
